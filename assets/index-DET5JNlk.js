...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(e,t,n){let r=new Float32Array(Xa),i=new q(0,1,0);return new Fi({name:`SphericalGaussianBlur`,defines:{n:Xa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Fi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function po(){return new Fi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mo(),fragmentShader:`
	...
	`}var ho=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Kr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,al={WIDTH:3e3,DEPTH:5e3,SEGMENTS:128,FOV:60,NEAR:1,FAR:6e3,CAMERA_HEIGHT:60,LOOK_AHEAD:300,BASE_SPEED:0,FLUX_SPEED_MULTIPLIER:4e3,COLOR_COOLDOWN:0},ol={RADIUS:150,WIDTH_SEGMENTS:32,HEIGHT_SEGMENTS:16,DISTANCE:1800,HEIGHT:40},sl={COUNT:5,WIDTH:4e3,HEIGHT:300,DISTANCE:1900,Y_OFFSET:100},cl={WIDTH:4e3,HEIGHT:800,DISTANCE:1850,Y_OFFSET:140,CENTER_GAP:.25},ll={WIDTH:4e3,HEIGHT:800,DISTANCE:2200,Y_OFFSET:150},ul=[{grid:new X(16711935),sun:new X(16737792)},{grid:new X(65535),sun:new X(16711782)},{grid:new X(16724889),sun:new X(16763904)},{grid:new X(6684927),sun:new X(16724736)},{grid:new X(65433),sun:new X(16737843)}],dl=class{constructor(e){this.offset=0,this.currentPaletteIndex=0,this.renderer=e,this.camera=this.buildCamera(),this.scene=new un,this.scene.background=new X(327688);let{mesh:t,material:n}=this.buildGrid();this.gridMesh=t,this.gridMaterial=n,this.scene.add(this.gridMesh);let{mesh:r,material:i}=this.buildSky();this.skyMesh=r,this.skyMaterial=i,this.scene.add(this.skyMesh),this.sunMesh=this.buildSun(),this.scene.add(this.sunMesh);let{mesh:a,material:o}=this.buildLasers();this.laserMesh=a,this.laserMaterial=o,this.scene.add(this.laserMesh);let{mesh:s,material:c}=this.buildBuildings();this.buildingsMesh=s,this.buildingsMaterial=c,this.scene.add(this.buildingsMesh),this.colorClock=new Pa,window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new ha(al.FOV,e,al.NEAR,al.FAR);return t.position.set(0,al.CAMERA_HEIGHT,0),t.lookAt(new q(0,20,al.LOOK_AHEAD)),t}buildGrid(){let e=new wi(al.WIDTH,al.DEPTH,al.SEGMENTS,al.SEGMENTS);e.rotateX(-Math.PI/2);let t=ul[0],n=new Fi({vertexShader:rl,fragmentShader:il,uniforms:{uTime:{value:0},uFlux:{value:0},uOffset:{value:0},uGridColor:{value:t.grid.clone()}}}),r=new Dr(e,n);return r.position.set(0,0,al.DEPTH*.5),{mesh:r,material:n}}buildSun(){let e=new Ti(ol.RADIUS,ol.WIDTH_SEGMENTS,ol.HEIGHT_SEGMENTS),t=ul[0],n=new Dr(e,new Fi({vertexShader:`
                uniform float uFlux;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,uniforms:{uSunColor:{value:t.sun.clone()},uFlux:{value:0}}}));return n.position.set(0,ol.HEIGHT,ol.DISTANCE),n}buildSky(){let e=new wi(ll.WIDTH,ll.HEIGHT),t=ul[0],n=new Fi({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uGlowColor:{value:t.sun.clone()},uFlux:{value:0}},depthWrite:!1}),r=new Dr(e,n);return r.position.set(0,ll.Y_OFFSET,ll.DISTANCE),{mesh:r,material:n}}buildBuildings(){let e=new wi(cl.WIDTH,cl.HEIGHT),t=ul[0],n=new Fi({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uEdgeColor:{value:t.grid.clone()},uFlux:{value:0},uCenterGap:{value:cl.CENTER_GAP}},side:2}),r=new Dr(e,n);return r.position.set(0,cl.Y_OFFSET,cl.DISTANCE),{mesh:r,material:n}}buildLasers(){let e=new wi(sl.WIDTH,sl.HEIGHT),t=ul[0],n=new Fi({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uLaserColor:{value:t.grid.clone()},uFlux:{value:0},uBeamCount:{value:sl.COUNT}},transparent:!0,depthWrite:!1,side:2}),r=new Dr(e,n);return r.position.set(0,sl.Y_OFFSET,sl.DISTANCE),{mesh:r,material:n}}update(e,t){let n=al.BASE_SPEED+t.flux*al.FLUX_SPEED_MULTIPLIER;this.offset+=n*e,this.gridMaterial.uniforms.uFlux.value=t.flux,this.gridMaterial.uniforms.uOffset.value=this.offset;let r=this.sunMesh.material;if(r.uniforms.uFlux.value=t.flux,this.skyMaterial.uniforms.uFlux.value=t.flux,this.laserMaterial.uniforms.uFlux.value=t.flux,this.buildingsMaterial.uniforms.uFlux.value=t.flux,t.event&&this.colorClock.getElapsedTime()>al.COLOR_COOLDOWN){this.colorClock=new Pa,this.currentPaletteIndex=(this.currentPaletteIndex+1)%ul.length;let e=ul[this.currentPaletteIndex];this.gridMaterial.uniforms.uGridColor.value.copy(e.grid),this.sunMesh.material.uniforms.uSunColor.value.copy(e.sun),this.skyMaterial.uniforms.uGlowColor.value.copy(e.sun),this.laserMaterial.uniforms.uLaserColor.value.copy(e.grid),this.buildingsMaterial.uniforms.uEdgeColor.value.copy(e.grid)}}render(){this.renderer.render(this.scene,this.camera)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.render()}dispose(){this.gridMesh.geometry.dispose(),this.gridMaterial.dispose(),this.sunMesh.geometry.dispose(),this.sunMesh.material.dispose(),this.skyMesh.geometry.dispose(),this.skyMaterial.dispose(),this.laserMesh.geometry.dispose(),this.laserMaterial.dispose(),this.buildingsMesh.geometry.dispose(),this.buildingsMaterial.dispose()}},fl=[5,6,8,10,12,14],pl=[{primary:new X(58879),secondary:new X(7089151),accent:new X(16722902)},{primary:new X(16756736),secondary:new X(16722541),accent:new X(2293714)},{primary:new X(11927355),secondary:new X(42751),accent:new X(16777215)},{primary:new X(16731392),secondary:new X(2687231),accent:new X(16767053)},{primary:new X(16711802),secondary:new X(65433),accent:new X(9067775)}],ml=`
void main() {
...
`,gl=class{constructor(e){this.time=0,this.currentPaletteIndex=0,this.currentSymmetryIndex=0,this.renderer=e,this.scene=new un,this.camera=new ga(-1,1,1,-1,0,1);let{mesh:t,material:n}=this.buildPrism();this.prismMesh=t,this.prismMaterial=n,this.scene.add(this.prismMesh)}buildPrism(){let e=pl[0],t=new wi(2,2),n=new Fi({vertexShader:ml,fragmentShader:hl,uniforms:{uResolution:{value:new K(window.innerWidth,window.innerHeight)},uTime:{value:0},uFlux:{value:0},uMeanFlux:{value:0},uSegments:{value:fl[0]},uPrimary:{value:e.primary.clone()},uSecondary:{value:e.secondary.clone()},uAccent:{value:e.accent.clone()}},depthTest:!1,depthWrite:!1});return{mesh:new Dr(t,n),material:n}}update(e,t){if(this.time+=e,this.prismMaterial.uniforms.uTime.value=this.time,this.prismMaterial.uniforms.uFlux.value=t.flux,this.prismMaterial.uniforms.uMeanFlux.value=t.meanFlux,t.event){this.currentPaletteIndex=(this.currentPaletteIndex+1)%pl.length,this.currentSymmetryIndex=(this.currentSymmetryIndex+1)%fl.length;let e=pl[this.currentPaletteIndex];this.prismMaterial.uniforms.uPrimary.value.copy(e.primary),this.prismMaterial.uniforms.uSecondary.value.copy(e.secondary),this.prismMaterial.uniforms.uAccent.value.copy(e.accent),this.prismMaterial.uniforms.uSegments.value=fl[this.currentSymmetryIndex]}}render(){this.renderer.render(this.scene,this.camera)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.prismMaterial.uniforms.uResolution.value.set(window.innerWidth,window.innerHeight),this.render()}dispose(){this.prismMesh.geometry.dispose(),this.prismMaterial.dispose()}},_l=`
...
`,yl={WIDTH:1200,DEPTH:2400,SEGMENTS:512,FOV:75,NEAR:1,FAR:2e3,CAMERA_HEIGHT:80,LOOK_AHEAD:200,BASE_SPEED:10,FLUX_SPEED_MULTIPLIER:3200,COLOR_COOLDOWN:.15},bl={STAR_COUNT:2e3,SPREAD_X:2e3,SPREAD_Y:600,MIN_HEIGHT:40,SPREAD_Z:2e3,SIZE:2,PARALLAX:1.5},xl=[{base:new X(4880970),highlight:new X(9424783)},{base:new X(6965813),highlight:new X(13213824)},{base:new X(3828362),highlight:new X(8044768)},{base:new X(8022602),highlight:new X(15257744)},{base:new X(5929562),highlight:new X(10539168)},{base:new X(6974090),highlight:new X(11579608)}],Sl=class{constructor(e){this.offset=0,this.time=0,this.currentPaletteIndex=0,this.renderer=e,this.camera=this.buildCamera(),this.scene=new un,this.scene.background=new X(328976);let{mesh:t,material:n}=this.buildTerrain();this.terrainMesh=t,this.terrainMaterial=n,this.scene.add(this.terrainMesh);let{points:r,geometry:i,material:a}=this.buildStarfield();this.starfield=r,this.starfieldGeometry=i,this.starfieldMaterial=a,this.scene.add(this.starfield),this.colorClock=new Pa,window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new ha(yl.FOV,e,yl.NEAR,yl.FAR);return t.position.set(0,yl.CAMERA_HEIGHT,-yl.DEPTH*.3),t.lookAt(new q(0,0,yl.LOOK_AHEAD)),t}buildTerrain(){let e=new wi(yl.WIDTH,yl.DEPTH,yl.SEGMENTS,yl.SEGMENTS);e.rotateX(-Math.PI/2);let t=xl[0],n=new Fi({vertexShader:_l,fragmentShader:vl,uniforms:{uTime:{value:0},uFlux:{value:0},uMeanFlux:{value:0},uOffset:{value:0},uBaseColor:{value:t.base.clone()},uHighlightColor:{value:t.highlight.clone()}}}),r=new Dr(e,n);return r.position.set(0,0,0),{mesh:r,material:n}}buildStarfield(){let e=bl.STAR_COUNT,t=new Float32Array(e*3);for(let n=0;n<e;n++){let e=n*3;t[e]=(Math.random()-.5)*bl.SPREAD_X,t[e+1]=Math.random()*bl.SPREAD_Y+bl.MIN_HEIGHT,t[e+2]=(Math.random()-.5)*bl.SPREAD_Z}let n=new ir;n.setAttribute(`position`,new Un(t,3));let r=new zr({color:16777215,size:bl.SIZE,sizeAttenuation:!0,transparent:!0,opacity:.9});return{points:new Wr(n,r),geometry:n,material:r}}update(e,t){this.time+=e;let n=yl.BASE_SPEED+t.flux*yl.FLUX_SPEED_MULTIPLIER;if(this.offset+=n*e,this.terrainMaterial.uniforms.uTime.value=this.time,this.terrainMaterial.uniforms.uFlux.value=t.flux,this.terrainMaterial.uniforms.uMeanFlux.value=t.meanFlux,this.terrainMaterial.uniforms.uOffset.value=this.offset,this.updateStarfield(t.flux,e),t.event&&this.colorClock.getElapsedTime()>yl.COLOR_COOLDOWN){this.colorClock=new Pa,this.currentPaletteIndex=(this.currentPaletteIndex+1)%xl.length;let e=xl[this.currentPaletteIndex];this.terrainMaterial.uniforms.uBaseColor.value.copy(e.base),this.terrainMaterial.uniforms.uHighlightColor.value.copy(e.highlight),this.starfieldMaterial.color.copy(e.highlight)}}updateStarfield(e,t){let n=this.starfieldGeometry.getAttribute(`position`),r=bl.STAR_COUNT,i=Math.min(t,.1),a=(yl.BASE_SPEED+e*yl.FLUX_SPEED_MULTIPLIER)*bl.PARALLAX;for(let e=0;e<r;e++){let t=e*3;n.array[t+2]-=a*i,n.array[t+2]<-bl.SPREAD_Z*.5&&(n.array[t+2]=bl.SPREAD_Z*.5,n.array[t]=(Math.random()-.5)*bl.SPREAD_X,n.array[t+1]=Math.random()*bl.SPREAD_Y+bl.MIN_HEIGHT)}n.needsUpdate=!0}render(){this.renderer.render(this.scene,this.camera)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.render()}dispose(){this.terrainMesh.geometry.dispose(),this.terrainMaterial.dispose(),this.starfieldGeometry.dispose(),this.starfieldMaterial.dispose()}},Cl={SLOW:.2,NORMAL:.5,FAST:.8},wl=32e3;Math.PI*4;function Tl(e){return e*wl}var $={SEGMENTS:100,SEGMENT_LENGTH:1600,RADIUS:100,CHUNK_SEGMENTS:8,CHUNK_TUBE_SEGMENTS:48,CHUNKS_BEHIND:1,CHUNKS_AHEAD:3,FOV:90,NEAR:1,FAR:1e4,CAMERA_OFFSET:100,ROTATION_COOLDOWN:.1};function El(e){let t=.15;return Math.random()>.5&&e+t<1?e+t:e-t>0?e-t:e+t}var Dl=class{constructor(e){this.rotDir=1,this.pos=0,this.tubeMeshes=new Map,this.activeTunnelChunk=-1,this.renderer=e,this.totalLength=$.SEGMENTS*$.SEGMENT_LENGTH,this.chunkCount=Math.ceil($.SEGMENTS/$.CHUNK_SEGMENTS),this.speed=Tl(Cl.NORMAL),this.camera=this.buildCamera(),this.scene=new un,this.curvePoints=this.createCurvePoints(),this.curve=new oi(this.curvePoints),this.orb=this.buildOrb(),this.orb.add(this.camera),this.aLight=this.buildALight(),this.clock=new Pa,new oa().load(`/Beat-Tube/img/stonePattern.jpg`,e=>{this.buildTube(e)}),window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new ha($.FOV,e,$.NEAR,$.FAR);return t.position.set(0,0,-$.CAMERA_OFFSET),t.rotation.y=Math.PI,t}buildALight(){let e=new _a(`orange`,.5);return this.scene.add(e),e}createCurvePoints(){let e=[new q(0,0,0)],t=0,n=0;for(let r=1;r<=$.SEGMENTS;r++){let r=Math.random()*.3-.25,i=$.SEGMENT_LENGTH*Math.sin(r);e.push(new q(0,t+=$.SEGMENT_LENGTH*Math.sin(r),n+=Math.sqrt($.SEGMENT_LENGTH*$.SEGMENT_LENGTH-i*i)))}return e}buildTube(t){this.tubeMaterial=new Li({side:1,map:t}),this.tubeMaterial.map&&(this.tubeMaterial.map.wrapS=e,this.tubeMaterial.map.wrapT=e,this.tubeMaterial.map.repeat.set($.CHUNK_TUBE_SEGMENTS/3,2)),this.updateTunnelChunks()}updateTunnelChunks(){if(!this.tubeMaterial)return;let e=Math.min(Math.floor(this.pos*$.SEGMENTS),$.SEGMENTS-1),t=Math.floor(e/$.CHUNK_SEGMENTS);if(t===this.activeTunnelChunk)return;this.activeTunnelChunk=t;let n=Math.max(0,t-$.CHUNKS_BEHIND),r=Math.min(this.chunkCount-1,t+$.CHUNKS_AHEAD),i=new Set;for(let e=n;e<=r;e++)i.add(e),this.tubeMeshes.has(e)||this.addTunnelChunk(e);for(let[e,t]of this.tubeMeshes)i.has(e)||(this.scene.remove(t),t.geometry.dispose(),this.tubeMeshes.delete(e))}addTunnelChunk(e){if(!this.tubeMaterial)return;let t=e*$.CHUNK_SEGMENTS,n=Math.min(t+$.CHUNK_SEGMENTS,$.SEGMENTS),r=Math.max(0,t-1),i=Math.min(this.curvePoints.length-1,n+1),a=new Dr(new Ei(new oi(this.curvePoints.slice(r,i+1)),$.CHUNK_TUBE_SEGMENTS,$.RADIUS,12,!1),this.tubeMaterial);this.tubeMeshes.set(e,a),this.scene.add(a)}buildOrb(){let e=new en;return e.position.set(0,0,0),this.scene.add(e),e}update(e,t){let n=(40+this.speed*t.flux)/this.totalLength*e;t.event&&(this.clock.getElapsedTime()>$.ROTATION_COOLDOWN&&(this.clock=new Pa,this.rotDir*=-1),this.aLight.color.r=El(this.aLight.color.r),this.aLight.color.b=El(this.aLight.color.b),this.aLight.color.g=El(this.aLight.color.g)),this.aLight.intensity=Math.min(.1+t.meanFlux*4,1),this.pos+n>=1&&(this.pos=0),this.orb.position.copy(this.curve.getPoint((this.pos+=n)%1)),this.updateTunnelChunks();let r=this.curve.getPoint((this.pos+n)%1),i=this.looking(r,this.orb.position),a=t.flux*2*e;this.orb.rotation.z+=a*this.rotDir,this.orb.rotation.x=i,this.camera.rotation.x=i}render(){this.renderer.render(this.scene,this.camera)}looking(e,t){let n=new q;return n.subVectors(e,t),-Math.atan(n.y/n.z)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.render()}dispose(){for(let e of this.tubeMeshes.values())e.geometry.dispose();this.tubeMeshes.clear(),this.tubeMaterial&&(this.tubeMaterial.map?.dispose(),this.tubeMaterial.dispose())}};function Ol(e,t){let n=document.getElementById(`file-share`),r=document.getElementById(`file-input`),i=document.getElementById(`file-error`),a=new FileReader;n.addEventListener(`click`,()=>{r.click()}),r.addEventListener(`change`,()=>{r.files&&r.files.length&&a.readAsArrayBuffer(r.files[0])}),a.addEventListener(`load`,()=>{(async()=>{let t=new window.AudioContext,n=a.result,r=await t.decodeAudioData(n),o=t.createBufferSource();o.disconnect(),o.buffer=r,o.connect(t.destination),o.start(),i.style.display=`none`,e(o,t)})().catch(()=>{i.style.display=`block`,t()})})}function kl(e){let t=document.getElementById(`default-play`),n=document.getElementById(`default-music`),r,i;t.addEventListener(`click`,t=>{t.stopPropagation(),r||(r=new window.AudioContext,n.play(),i=r.createMediaElementSource(n)),i.connect(r.destination),e(i,r)})}function Al(e){let t=document.getElementById(`scene-prev`),n=document.getElementById(`scene-next`);t&&t.addEventListener(`click`,t=>{t.stopPropagation(),e.prev()}),n&&n.addEventListener(`click`,t=>{t.stopPropagation(),e.next()})}function jl(e,t){let n=document.getElementById(`scr-share`),r=document.getElementById(`scr-error`),i=async()=>{let t=new window.AudioContext,n=await navigator.mediaDevices.getDisplayMedia({audio:!0,video:!0}),i=t.createMediaStreamSource(n);r.style.display=`none`,e(i,t)};n.addEventListener(`click`,()=>{i().catch(()=>{r.style.display=`block`,t()})})}var Ml=new Pa,Nl=document.getElementById(`overlay`),Pl=document.getElementById(`scene-prev`),Fl=document.getElementById(`scene-next`),Il=Ul();Nl.prepend(el.createButton(Il));var Ll=new nl(Il);Ll.register(new gl(Il)),Ll.register(new dl(Il)),Ll.register(new Sl(Il)),Ll.register(new Dl(Il)),Ll.render(),Al(Ll);var Rl=!1,zl;function Bl(e,t){zl&&zl!==e&&zl.disconnect(),Il.setAnimationLoop(null),zl=e;let n=new tl(t);e.connect(n.analyser),Nl.style.display=`none`,Pl.classList.add(`visible`),Fl.classList.add(`visible`),Rl=!0,Il.setAnimationLoop(()=>Hl(n))}function Vl(){Nl.style.display=`flex`}function Hl(e){let t=Ml.getDelta(),n=e.update(t);Ll.update(t,n),Ll.render()}document.addEventListener(`click`,()=>{Rl&&(Nl.style.display===`none`?Nl.style.display=`flex`:Nl.style.display=`none`)}),window.addEventListener(`resize`,()=>{Ll.resize()});function Ul(){let e=new $c;return e.xr.enabled=!0,e.xr.setReferenceSpaceType(`local`),e.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(e.domElement),e}Ol(Bl,Vl),jl(Bl,Vl),kl(Bl);