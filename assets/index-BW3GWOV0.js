...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(e,t,n){let r=new Float32Array(Za),i=new q(0,1,0);return new Ii({name:`SphericalGaussianBlur`,defines:{n:Za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function po(){return new Ii({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function mo(){return new Ii({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ho(),fragmentShader:`
	...
	`}var go=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new qr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,ol={WIDTH:3e3,DEPTH:5e3,SEGMENTS:128,FOV:60,NEAR:1,FAR:6e3,CAMERA_HEIGHT:60,LOOK_AHEAD:300,BASE_SPEED:0,FLUX_SPEED_MULTIPLIER:4e3,COLOR_COOLDOWN:0},sl={RADIUS:150,WIDTH_SEGMENTS:32,HEIGHT_SEGMENTS:16,DISTANCE:1800,HEIGHT:40},cl={COUNT:5,WIDTH:4e3,HEIGHT:300,DISTANCE:1900,Y_OFFSET:100},ll={WIDTH:4e3,HEIGHT:800,DISTANCE:1850,Y_OFFSET:140,CENTER_GAP:.25},ul={WIDTH:4e3,HEIGHT:800,DISTANCE:2200,Y_OFFSET:150},dl=[{grid:new X(16711935),sun:new X(16737792)},{grid:new X(65535),sun:new X(16711782)},{grid:new X(16724889),sun:new X(16763904)},{grid:new X(6684927),sun:new X(16724736)},{grid:new X(65433),sun:new X(16737843)}],fl=class{constructor(e){this.offset=0,this.currentPaletteIndex=0,this.renderer=e,this.camera=this.buildCamera(),this.scene=new dn,this.scene.background=new X(327688);let{mesh:t,material:n}=this.buildGrid();this.gridMesh=t,this.gridMaterial=n,this.scene.add(this.gridMesh);let{mesh:r,material:i}=this.buildSky();this.skyMesh=r,this.skyMaterial=i,this.scene.add(this.skyMesh),this.sunMesh=this.buildSun(),this.scene.add(this.sunMesh);let{mesh:a,material:o}=this.buildLasers();this.laserMesh=a,this.laserMaterial=o,this.scene.add(this.laserMesh);let{mesh:s,material:c}=this.buildBuildings();this.buildingsMesh=s,this.buildingsMaterial=c,this.scene.add(this.buildingsMesh),this.colorClock=new Fa,window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new ga(ol.FOV,e,ol.NEAR,ol.FAR);return t.position.set(0,ol.CAMERA_HEIGHT,0),t.lookAt(new q(0,20,ol.LOOK_AHEAD)),t}buildGrid(){let e=new Ti(ol.WIDTH,ol.DEPTH,ol.SEGMENTS,ol.SEGMENTS);e.rotateX(-Math.PI/2);let t=dl[0],n=new Ii({vertexShader:il,fragmentShader:al,uniforms:{uTime:{value:0},uFlux:{value:0},uOffset:{value:0},uGridColor:{value:t.grid.clone()}}}),r=new Or(e,n);return r.position.set(0,0,ol.DEPTH*.5),{mesh:r,material:n}}buildSun(){let e=new Ei(sl.RADIUS,sl.WIDTH_SEGMENTS,sl.HEIGHT_SEGMENTS),t=dl[0],n=new Or(e,new Ii({vertexShader:`
                uniform float uFlux;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,uniforms:{uSunColor:{value:t.sun.clone()},uFlux:{value:0}}}));return n.position.set(0,sl.HEIGHT,sl.DISTANCE),n}buildSky(){let e=new Ti(ul.WIDTH,ul.HEIGHT),t=dl[0],n=new Ii({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uGlowColor:{value:t.sun.clone()},uFlux:{value:0}},depthWrite:!1}),r=new Or(e,n);return r.position.set(0,ul.Y_OFFSET,ul.DISTANCE),{mesh:r,material:n}}buildBuildings(){let e=new Ti(ll.WIDTH,ll.HEIGHT),t=dl[0],n=new Ii({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uEdgeColor:{value:t.grid.clone()},uFlux:{value:0},uCenterGap:{value:ll.CENTER_GAP}},side:2}),r=new Or(e,n);return r.position.set(0,ll.Y_OFFSET,ll.DISTANCE),{mesh:r,material:n}}buildLasers(){let e=new Ti(cl.WIDTH,cl.HEIGHT),t=dl[0],n=new Ii({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uLaserColor:{value:t.grid.clone()},uFlux:{value:0},uBeamCount:{value:cl.COUNT}},transparent:!0,depthWrite:!1,side:2}),r=new Or(e,n);return r.position.set(0,cl.Y_OFFSET,cl.DISTANCE),{mesh:r,material:n}}update(e,t){let n=ol.BASE_SPEED+t.flux*ol.FLUX_SPEED_MULTIPLIER;this.offset+=n*e,this.gridMaterial.uniforms.uFlux.value=t.flux,this.gridMaterial.uniforms.uOffset.value=this.offset;let r=this.sunMesh.material;if(r.uniforms.uFlux.value=t.flux,this.skyMaterial.uniforms.uFlux.value=t.flux,this.laserMaterial.uniforms.uFlux.value=t.flux,this.buildingsMaterial.uniforms.uFlux.value=t.flux,t.event&&this.colorClock.getElapsedTime()>ol.COLOR_COOLDOWN){this.colorClock=new Fa,this.currentPaletteIndex=(this.currentPaletteIndex+1)%dl.length;let e=dl[this.currentPaletteIndex];this.gridMaterial.uniforms.uGridColor.value.copy(e.grid),this.sunMesh.material.uniforms.uSunColor.value.copy(e.sun),this.skyMaterial.uniforms.uGlowColor.value.copy(e.sun),this.laserMaterial.uniforms.uLaserColor.value.copy(e.grid),this.buildingsMaterial.uniforms.uEdgeColor.value.copy(e.grid)}}render(){this.renderer.render(this.scene,this.camera)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.render()}dispose(){this.gridMesh.geometry.dispose(),this.gridMaterial.dispose(),this.sunMesh.geometry.dispose(),this.sunMesh.material.dispose(),this.skyMesh.geometry.dispose(),this.skyMaterial.dispose(),this.laserMesh.geometry.dispose(),this.laserMaterial.dispose(),this.buildingsMesh.geometry.dispose(),this.buildingsMaterial.dispose()}},pl=[5,6,8,10,12,14],ml=[{primary:new X(58879),secondary:new X(7089151),accent:new X(16722902)},{primary:new X(16756736),secondary:new X(16722541),accent:new X(2293714)},{primary:new X(11927355),secondary:new X(42751),accent:new X(16777215)},{primary:new X(16731392),secondary:new X(2687231),accent:new X(16767053)},{primary:new X(16711802),secondary:new X(65433),accent:new X(9067775)}],hl=`
void main() {
...
`,_l=class{constructor(e){this.time=0,this.currentPaletteIndex=0,this.currentSymmetryIndex=0,this.renderer=e,this.scene=new dn,this.camera=new _a(-1,1,1,-1,0,1);let{mesh:t,material:n}=this.buildPrism();this.prismMesh=t,this.prismMaterial=n,this.scene.add(this.prismMesh)}buildPrism(){let e=ml[0],t=new Ti(2,2),n=new Ii({vertexShader:hl,fragmentShader:gl,uniforms:{uResolution:{value:new K(window.innerWidth,window.innerHeight)},uTime:{value:0},uFlux:{value:0},uMeanFlux:{value:0},uSegments:{value:pl[0]},uPrimary:{value:e.primary.clone()},uSecondary:{value:e.secondary.clone()},uAccent:{value:e.accent.clone()}},depthTest:!1,depthWrite:!1});return{mesh:new Or(t,n),material:n}}update(e,t){if(this.time+=e,this.prismMaterial.uniforms.uTime.value=this.time,this.prismMaterial.uniforms.uFlux.value=t.flux,this.prismMaterial.uniforms.uMeanFlux.value=t.meanFlux,t.event){this.currentPaletteIndex=(this.currentPaletteIndex+1)%ml.length,this.currentSymmetryIndex=(this.currentSymmetryIndex+1)%pl.length;let e=ml[this.currentPaletteIndex];this.prismMaterial.uniforms.uPrimary.value.copy(e.primary),this.prismMaterial.uniforms.uSecondary.value.copy(e.secondary),this.prismMaterial.uniforms.uAccent.value.copy(e.accent),this.prismMaterial.uniforms.uSegments.value=pl[this.currentSymmetryIndex]}}render(){this.renderer.render(this.scene,this.camera)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.prismMaterial.uniforms.uResolution.value.set(window.innerWidth,window.innerHeight),this.render()}dispose(){this.prismMesh.geometry.dispose(),this.prismMaterial.dispose()}},vl=`
...
`,bl={WIDTH:1200,DEPTH:2400,SEGMENTS:512,FOV:75,NEAR:1,FAR:2e3,CAMERA_HEIGHT:80,LOOK_AHEAD:200,BASE_SPEED:10,FLUX_SPEED_MULTIPLIER:3200,COLOR_COOLDOWN:.15},xl={STAR_COUNT:2e3,SPREAD_X:2e3,SPREAD_Y:600,MIN_HEIGHT:40,SPREAD_Z:2e3,SIZE:2,PARALLAX:1.5},Sl=[{base:new X(4880970),highlight:new X(9424783)},{base:new X(6965813),highlight:new X(13213824)},{base:new X(3828362),highlight:new X(8044768)},{base:new X(8022602),highlight:new X(15257744)},{base:new X(5929562),highlight:new X(10539168)},{base:new X(6974090),highlight:new X(11579608)}],Cl=class{constructor(e){this.offset=0,this.time=0,this.currentPaletteIndex=0,this.renderer=e,this.camera=this.buildCamera(),this.scene=new dn,this.scene.background=new X(328976);let{mesh:t,material:n}=this.buildTerrain();this.terrainMesh=t,this.terrainMaterial=n,this.scene.add(this.terrainMesh);let{points:r,geometry:i,material:a}=this.buildStarfield();this.starfield=r,this.starfieldGeometry=i,this.starfieldMaterial=a,this.scene.add(this.starfield),this.colorClock=new Fa,window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new ga(bl.FOV,e,bl.NEAR,bl.FAR);return t.position.set(0,bl.CAMERA_HEIGHT,-bl.DEPTH*.3),t.lookAt(new q(0,0,bl.LOOK_AHEAD)),t}buildTerrain(){let e=new Ti(bl.WIDTH,bl.DEPTH,bl.SEGMENTS,bl.SEGMENTS);e.rotateX(-Math.PI/2);let t=Sl[0],n=new Ii({vertexShader:vl,fragmentShader:yl,uniforms:{uTime:{value:0},uFlux:{value:0},uMeanFlux:{value:0},uOffset:{value:0},uBaseColor:{value:t.base.clone()},uHighlightColor:{value:t.highlight.clone()}}}),r=new Or(e,n);return r.position.set(0,0,0),{mesh:r,material:n}}buildStarfield(){let e=xl.STAR_COUNT,t=new Float32Array(e*3);for(let n=0;n<e;n++){let e=n*3;t[e]=(Math.random()-.5)*xl.SPREAD_X,t[e+1]=Math.random()*xl.SPREAD_Y+xl.MIN_HEIGHT,t[e+2]=(Math.random()-.5)*xl.SPREAD_Z}let n=new ar;n.setAttribute(`position`,new Wn(t,3));let r=new Br({color:16777215,size:xl.SIZE,sizeAttenuation:!0,transparent:!0,opacity:.9});return{points:new Gr(n,r),geometry:n,material:r}}update(e,t){this.time+=e;let n=bl.BASE_SPEED+t.flux*bl.FLUX_SPEED_MULTIPLIER;if(this.offset+=n*e,this.terrainMaterial.uniforms.uTime.value=this.time,this.terrainMaterial.uniforms.uFlux.value=t.flux,this.terrainMaterial.uniforms.uMeanFlux.value=t.meanFlux,this.terrainMaterial.uniforms.uOffset.value=this.offset,this.updateStarfield(t.flux,e),t.event&&this.colorClock.getElapsedTime()>bl.COLOR_COOLDOWN){this.colorClock=new Fa,this.currentPaletteIndex=(this.currentPaletteIndex+1)%Sl.length;let e=Sl[this.currentPaletteIndex];this.terrainMaterial.uniforms.uBaseColor.value.copy(e.base),this.terrainMaterial.uniforms.uHighlightColor.value.copy(e.highlight),this.starfieldMaterial.color.copy(e.highlight)}}updateStarfield(e,t){let n=this.starfieldGeometry.getAttribute(`position`),r=xl.STAR_COUNT,i=Math.min(t,.1),a=(bl.BASE_SPEED+e*bl.FLUX_SPEED_MULTIPLIER)*xl.PARALLAX;for(let e=0;e<r;e++){let t=e*3;n.array[t+2]-=a*i,n.array[t+2]<-xl.SPREAD_Z*.5&&(n.array[t+2]=xl.SPREAD_Z*.5,n.array[t]=(Math.random()-.5)*xl.SPREAD_X,n.array[t+1]=Math.random()*xl.SPREAD_Y+xl.MIN_HEIGHT)}n.needsUpdate=!0}render(){this.renderer.render(this.scene,this.camera)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.render()}dispose(){this.terrainMesh.geometry.dispose(),this.terrainMaterial.dispose(),this.starfieldGeometry.dispose(),this.starfieldMaterial.dispose()}},wl={SLOW:.2,NORMAL:.5,FAST:.8},Tl=32e3;Math.PI*4;function El(e){return e*Tl}var $={SEGMENTS:100,SEGMENT_LENGTH:1600,RADIUS:100,CHUNK_SEGMENTS:8,CHUNK_TUBE_SEGMENTS:48,CHUNKS_BEHIND:1,CHUNKS_AHEAD:3,FOV:90,NEAR:1,FAR:1e4,CAMERA_OFFSET:100,ROTATION_COOLDOWN:.1};function Dl(e){let t=.15;return Math.random()>.5&&e+t<1?e+t:e-t>0?e-t:e+t}var Ol=class{constructor(e){this.rotDir=1,this.pos=0,this.tubeMeshes=new Map,this.activeTunnelChunk=-1,this.renderer=e,this.totalLength=$.SEGMENTS*$.SEGMENT_LENGTH,this.chunkCount=Math.ceil($.SEGMENTS/$.CHUNK_SEGMENTS),this.speed=El(wl.NORMAL),this.camera=this.buildCamera(),this.scene=new dn,this.curvePoints=this.createCurvePoints(),this.curve=new si(this.curvePoints),this.orb=this.buildOrb(),this.orb.add(this.camera),this.aLight=this.buildALight(),this.clock=new Fa,new sa().load(`/Beat-Tube/img/stonePattern.jpg`,e=>{this.buildTube(e)}),window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new ga($.FOV,e,$.NEAR,$.FAR);return t.position.set(0,0,-$.CAMERA_OFFSET),t.rotation.y=Math.PI,t}buildALight(){let e=new va(`orange`,.5);return this.scene.add(e),e}createCurvePoints(){let e=[new q(0,0,0)],t=0,n=0;for(let r=1;r<=$.SEGMENTS;r++){let r=Math.random()*.3-.25,i=$.SEGMENT_LENGTH*Math.sin(r);e.push(new q(0,t+=$.SEGMENT_LENGTH*Math.sin(r),n+=Math.sqrt($.SEGMENT_LENGTH*$.SEGMENT_LENGTH-i*i)))}return e}buildTube(t){this.tubeMaterial=new Ri({side:1,map:t}),this.tubeMaterial.map&&(this.tubeMaterial.map.wrapS=e,this.tubeMaterial.map.wrapT=e,this.tubeMaterial.map.repeat.set($.CHUNK_TUBE_SEGMENTS/3,2)),this.updateTunnelChunks()}updateTunnelChunks(){if(!this.tubeMaterial)return;let e=Math.min(Math.floor(this.pos*$.SEGMENTS),$.SEGMENTS-1),t=Math.floor(e/$.CHUNK_SEGMENTS);if(t===this.activeTunnelChunk)return;this.activeTunnelChunk=t;let n=Math.max(0,t-$.CHUNKS_BEHIND),r=Math.min(this.chunkCount-1,t+$.CHUNKS_AHEAD),i=new Set;for(let e=n;e<=r;e++)i.add(e),this.tubeMeshes.has(e)||this.addTunnelChunk(e);for(let[e,t]of this.tubeMeshes)i.has(e)||(this.scene.remove(t),t.geometry.dispose(),this.tubeMeshes.delete(e))}addTunnelChunk(e){if(!this.tubeMaterial)return;let t=e*$.CHUNK_SEGMENTS,n=Math.min(t+$.CHUNK_SEGMENTS,$.SEGMENTS),r=Math.max(0,t-1),i=Math.min(this.curvePoints.length-1,n+1),a=new Or(new Di(new si(this.curvePoints.slice(r,i+1)),$.CHUNK_TUBE_SEGMENTS,$.RADIUS,12,!1),this.tubeMaterial);this.tubeMeshes.set(e,a),this.scene.add(a)}buildOrb(){let e=new tn;return e.position.set(0,0,0),this.scene.add(e),e}update(e,t){let n=(40+this.speed*t.flux)/this.totalLength*e;t.event&&(this.clock.getElapsedTime()>$.ROTATION_COOLDOWN&&(this.clock=new Fa,this.rotDir*=-1),this.aLight.color.r=Dl(this.aLight.color.r),this.aLight.color.b=Dl(this.aLight.color.b),this.aLight.color.g=Dl(this.aLight.color.g)),this.aLight.intensity=Math.min(.1+t.meanFlux*4,1),this.pos+n>=1&&(this.pos=0),this.orb.position.copy(this.curve.getPoint((this.pos+=n)%1)),this.updateTunnelChunks();let r=this.curve.getPoint((this.pos+n)%1),i=this.looking(r,this.orb.position),a=t.flux*2*e;this.orb.rotation.z+=a*this.rotDir,this.orb.rotation.x=i,this.camera.rotation.x=i}render(){this.renderer.render(this.scene,this.camera)}looking(e,t){let n=new q;return n.subVectors(e,t),-Math.atan(n.y/n.z)}resize(){this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.render()}dispose(){for(let e of this.tubeMeshes.values())e.geometry.dispose();this.tubeMeshes.clear(),this.tubeMaterial&&(this.tubeMaterial.map?.dispose(),this.tubeMaterial.dispose())}};function kl(e,t){let n=document.getElementById(`file-share`),r=document.getElementById(`file-input`),i=document.getElementById(`file-error`),a=new FileReader;n.addEventListener(`click`,()=>{r.click()}),r.addEventListener(`change`,()=>{r.files&&r.files.length&&a.readAsArrayBuffer(r.files[0])}),a.addEventListener(`load`,()=>{(async()=>{let t=new window.AudioContext,n=a.result,r=await t.decodeAudioData(n),o=t.createBufferSource();o.disconnect(),o.buffer=r,o.connect(t.destination),o.start(),i.style.display=`none`,e(o,t)})().catch(()=>{i.style.display=`block`,t()})})}function Al(e){let t=document.getElementById(`default-play`),n=document.getElementById(`default-music`),r,i;t.addEventListener(`click`,t=>{t.stopPropagation(),r||(r=new window.AudioContext,n.play(),i=r.createMediaElementSource(n)),i.connect(r.destination),e(i,r)})}function jl(e){let t=document.getElementById(`scene-prev`),n=document.getElementById(`scene-next`);t&&t.addEventListener(`click`,t=>{t.stopPropagation(),e.prev()}),n&&n.addEventListener(`click`,t=>{t.stopPropagation(),e.next()})}function Ml(e,t){let n=document.getElementById(`scr-share`),r=document.getElementById(`scr-error`),i=async()=>{let t=new window.AudioContext,n=await navigator.mediaDevices.getDisplayMedia({audio:!0,video:!0}),i=t.createMediaStreamSource(n);r.style.display=`none`,e(i,t)};n.addEventListener(`click`,()=>{i().catch(()=>{r.style.display=`block`,t()})})}var Nl=new Fa,Pl=document.getElementById(`overlay`),Fl=document.getElementById(`scene-prev`),Il=document.getElementById(`scene-next`),Ll=Wl();Pl.prepend(tl.createButton(Ll));var Rl=new rl(Ll);Rl.register(new _l(Ll)),Rl.register(new fl(Ll)),Rl.register(new Cl(Ll)),Rl.register(new Ol(Ll)),Rl.render(),jl(Rl);var zl=!1,Bl;function Vl(e,t){Bl&&Bl!==e&&Bl.disconnect(),Ll.setAnimationLoop(null),Bl=e;let n=new nl(t);e.connect(n.analyser),Pl.style.display=`none`,Fl.classList.add(`visible`),Il.classList.add(`visible`),zl=!0,Ll.setAnimationLoop(()=>Ul(n))}function Hl(){Pl.style.display=`flex`}function Ul(e){let t=Nl.getDelta(),n=e.update(t);Rl.update(t,n),Rl.render()}document.addEventListener(`click`,()=>{zl&&(Pl.style.display===`none`?Pl.style.display=`flex`:Pl.style.display=`none`)}),window.addEventListener(`resize`,()=>{Rl.resize()});function Wl(){let e=new el;return e.xr.enabled=!0,e.xr.setReferenceSpaceType(`local`),e.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(e.domElement),e}kl(Vl,Hl),Ml(Vl,Hl),Al(Vl);